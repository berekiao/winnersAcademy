package com.application.WinnersAcademy.jwt;
...
public class JwtUtils {
    ...
    private byte[] apiKeySecretBytes = Keys.secretKeyFor(SignatureAlgorithm.HS512).getEncoded();
    ...
    public boolean validateJwtToken(String authToken) {
        try {
            Jwts.parser().setSigningKey(apiKeySecretBytes).parseClaimsJws(authToken);
            return true;
